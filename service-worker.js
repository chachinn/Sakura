const SHELL_CACHE_VERSION = "sakura-shell-v75";
...
const APP_SHELL = [
    ...
    "./style.css?v=46",
    "./app.js?v=54",
    "./data/practice-what-would-you-say.js?v=1",
    "./data/practice-sentence-builder.js?v=1",
    "./data/practice-one-line-many-personalities.js?v=1",
    "./data/kanji.js",
